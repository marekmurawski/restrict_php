...
if ( Plugin::isEnabled('part_revisions') ) {
    Observer::stopObserving('part_edit_before_save', 'save_old_part');
    Observer::stopObserving('part_add_before_save', 'save_old_part');
    Observer::stopObserving('page_edit_after_save', 'show_part_revisions_saved_info');
    Observer::stopObserving('view_page_edit_tab_links', 'PartRevisionsController::Callback_view_page_edit_tab_links');
    Observer::stopObserving('view_page_edit_tabs', 'PartRevisionsController::Callback_view_page_edit_tabs');
    Observer::stopObserving('view_page_edit_popup', 'PartRevisionsController::Callback_view_page_edit_popup');
}
...
/**
 * If PART REVISIONS plugin is enabled
 *  - restore it's observers AFTER RESTRICT PHP
 */
if ( Plugin::isEnabled('part_revisions') ) {
